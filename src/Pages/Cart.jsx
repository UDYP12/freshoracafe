      ...
      <div className="flex-1 max-w-4xl">
        ...
        {cartArray.map((product, index) => (
          ...
          >
              ...
              <div>
                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className="flex items-center">
                    <p>Qty:</p>
                    <select value={cartItems[product._id]} className="outline-none"onChange={e => updateCardItems(product._id, Number (e.target.value))} >
            ...
            <button  onClick={()=>removeFromCard(product._id)} className="cursor-pointer mx-auto">
             <img src={assets.remove_icon} className="inline-block w-6 h-6" alt="" />
            </button>
          </div>
        ))}
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
          ...
          <div className="relative flex justify-between items-start mt-2">
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                ...
                >
                  {address.street},{address.country},{address.state},{address.city}
                </p>)) }
                <p
        ...
        <div className="text-gray-500 mt-4 space-y-2">
          <p className="flex justify-between">
            <span>Price</span>
            <span>{currency}{getCardAmmount()}</span>
          </p>
          <p className="flex justify-between">
          ...
          <p className="flex justify-between">
            <span>Tax (2%)</span>
            <span>{currency} {getCardAmmount() * 2}</span>
          </p>
          <p className="flex justify-between text-lg font-medium mt-3">
            <span>Total Amount:</span>
            <span>{currency}{getCardAmmount() + getCardAmmount() * 2 / 100}</span>
          </p>
        </div>
