...
const ProductCard = ({ product }) => {
  ...
  const { currency, addToCart, removeFromCard, cartItems, navigate } =
    useAppContext();
          ...
          <div className="flex items-end justify-between mt-3">
            ...
            <div onClick={(e)=>{e.stopPropagation();}} className="text-indigo-500">
              {!cartItems[product._id] ? (
                <button
                  className="flex items-center justify-center cursor-pointer gap-1 bg-indigo-100 border border-indigo-300 md:w-[80px] w-[64px] h-[34px] rounded text-black font-medium"
